...
public class BsonDataSetBeanInfo extends BeanInfoSupport {
    ...
    private static final String BATCH_SIZE = "batchSize";            //$NON-NLS-1$
    ...
    public BsonDataSetBeanInfo() {
        super(BsonDataSet.class);
        
        createPropertyGroup("bsonfeed", new String[] {
                FILENAME,
                VARIABLE_NAME,
                BATCH_SIZE,
                RECYCLE,
